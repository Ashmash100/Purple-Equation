...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/style.scss
var style = __webpack_require__(450);
...
var src_images = ["./images/campaign-creators-yktK2qaiVHI-unsplash.jpeg", "./images/emile-perron-xrVDYZRGdw4-unsplash.jpeg", "./images/laptop.jpeg", "./images/marketing.jpeg"];
var changeBg = function changeBg() {
  var changingImage = document.getElementById("changing-image");
  var bg = src_images[Math.floor(Math.random() * src_images.length)];
  changingImage.style.backgroundImage = "linear-gradient( to right,rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.2)),url(".concat(bg, ")");
};
